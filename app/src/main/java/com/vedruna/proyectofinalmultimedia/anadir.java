...
/**
 * Fragmento para añadir un jugador.
 */
...
public class anadir extends Fragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id.isEmpty() || nombre.isEmpty() || posicion.isEmpty() || equipo.isEmpty()) {
                    ...
                    mostrarToast("Todos los campos son obligatorios máquina");
                } else {
     ...
     * @param player El jugador a ser creado.
     */
    private void create(Player player){
        ...
        call.enqueue(new Callback<Player>() {
            ...
            public void onResponse(Call<Player> call, Response<Player> response) {
                ...
                mostrarToast("Jugador añadido correctamente crack: " + player.getName());
            }
            @Override
